...
private:
    ...
    void Update()
    {
        ...
        imu_linear_acceleration_estimated_bias = estimator_.imu_linear_acceleration_bias[WINDOW_SIZE];
        imu_angular_velocity_estimated_bias = estimator_.imu_angular_velocity_bias[WINDOW_SIZE];
