  ...
  virtual bool Evaluate(double const *const *parameters, double *residuals,
    ...
    if (jacobians) {
      ...
      if (pre_integration->jacobian.maxCoeff() > 1e8 ||
        ...
        spdlog::warn("numerical unstable in preintegration");
        // std::cout << pre_integration->jacobian << std::endl;
        //  throw(std::runtime_error("numerical unstable in preintegration"))
      }
      ...
      if (jacobians[0]) {
        ...
        Eigen::Quaterniond corrected_delta_q =
            ...
            Utility::deltaQuat(dq_dbg * (Bgi - pre_integration->linearized_bg));
        ...
        if (jacobian_pose_i.maxCoeff() > 1e8 ||
          ...
          //  throw(std::runtime_error("Jacobian exploded. Numerical unstable in
          //  preintegration"));
        }
      }
      if (jacobians[1]) {
