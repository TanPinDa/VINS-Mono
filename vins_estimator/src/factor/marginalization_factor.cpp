...
void MarginalizationInfo::marginalize() {
  ...
  // spdlog::debug("marginalization, pos: {0}, m: {1}, n: {2}, size: {3}", pos,
  // m, n, (int)parameter_block_idx.size());
  ...
  */
  ...
  // spdlog::info("A diff {0} , b diff {1} ", (A - tmp_A).sum(), (b -
  // tmp_b).sum());
  ...
  //     spdlog::critical("Min eigenvalue is too low:
  //     {}",saes.eigenvalues().minCoeff()); throw(std::runtime_error("Min
  //     eigenvalue is too low"));
  // }
